...
bin/aiff2riff: build/aiff.o build/aiff2riff.o build/bytes.o build/constants.o build/extended.o build/id3.o build/io.o build/paths.o build/riff.o
...
bin/mel: build/bytes.o build/constants.o build/extended.o build/fjs.o build/id3.o build/interpreter.o build/intervals.o build/io.o build/lcg.o build/mel.o build/paths.o build/rationals.o build/riff.o build/samples.o build/search.o
bin/mel.cgi: build/bytes.o build/cgi.o build/constants.o build/extended.o build/fjs.o build/id3.o build/interpreter.o build/intervals.o build/io.o build/lcg.o build/paths.o build/rationals.o build/riff.o build/samples.o build/search.o
bin/repeat: build/bytes.o build/constants.o build/extended.o build/id3.o build/io.o build/paths.o build/rationals.o build/repeat.o build/riff.o
bin/riff2aiff: build/aiff.o build/bytes.o build/constants.o build/extended.o build/id3.o build/io.o build/paths.o build/riff.o build/riff2aiff.o
bin/stack: build/bytes.o build/constants.o build/extended.o build/id3.o build/io.o build/paths.o build/riff.o build/stack.o
bin/stick: build/bytes.o build/constants.o build/extended.o build/id3.o build/io.o build/paths.o build/riff.o build/stick.o
bin/stretch: build/bytes.o build/constants.o build/extended.o build/id3.o build/io.o build/paths.o build/rationals.o build/riff.o build/stretch.o
bin/trim: build/bytes.o build/constants.o build/extended.o build/id3.o build/io.o build/paths.o build/rationals.o build/riff.o build/trim.o
...
build/riff.o: build/bytes.o build/constants.o build/extended.o build/id3.o
