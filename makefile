...
programs = harmonics mel repeat reverse stack stick
...
clean:
	@rm -f $(needless) aiff.o constants.o extended.o harmonics.o interpreter.o intervals.o io.o mel.o paths.o rationals.o repeat.o reverse.o samples.o search.o spectra.o stack.o stick.o
...
repeat: aiff.o constants.o extended.o io.o paths.o repeat.o
reverse: aiff.o constants.o extended.o io.o paths.o reverse.o
stack: aiff.o constants.o extended.o io.o stack.o
