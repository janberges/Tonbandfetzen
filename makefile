...
programs = bin/aiff2riff bin/fit bin/flange bin/harmonics bin/inspect bin/mel bin/noise bin/repeat bin/reverse bin/riff2aiff bin/stack bin/stick
...
clean:
	@rm -f $(needless) build/aiff.o build/aiff2riff.o build/constants.o build/extended.o build/fit.o build/flange.o build/harmonics.o build/inspect.o build/interpreter.o build/intervals.o build/io.o build/mel.o build/noise.o build/paths.o build/rationals.o build/repeat.o build/reverse.o build/riff.o build/riff2aiff.o build/samples.o build/search.o build/spectra.o build/stack.o build/stick.o
