...
programs = bin/flange bin/harmonics bin/mel bin/repeat bin/reverse bin/stack bin/stick
...
clean:
	@rm -f $(needless) build/aiff.o build/constants.o build/extended.o build/flange.o build/harmonics.o build/interpreter.o build/intervals.o build/io.o build/mel.o build/paths.o build/rationals.o build/repeat.o build/reverse.o build/samples.o build/search.o build/spectra.o build/stack.o build/stick.o
