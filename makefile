...
programs = harmonics mel reverse stack stick
...
clean:
	@rm -f $(needless) aiff.o constants.o extended.o harmonics.o interpreter.o intervals.o io.o mel.o paths.o rationals.o reverse.o samples.o search.o spectra.o stack.o stick.o
