...
programs = bin/aiff2riff bin/flange bin/harmonics bin/inspect bin/mel bin/noise bin/repeat bin/riff2aiff bin/stack bin/stick bin/stretch
...
clean:
	@rm -f $(needless) build/aiff.o build/aiff2riff.o build/constants.o build/extended.o build/flange.o build/harmonics.o build/inspect.o build/interpreter.o build/intervals.o build/io.o build/mel.o build/noise.o build/paths.o build/rationals.o build/repeat.o build/riff.o build/riff2aiff.o build/samples.o build/search.o build/spectra.o build/stack.o build/stick.o build/stretch.o
